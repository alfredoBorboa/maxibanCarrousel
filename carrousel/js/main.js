$( document ).ready( function(){
  ...
  textures[ 0 ] = loader.load('img/maxiban.png');//JAIME: aquí se cargan las imágenes para cada botón.
  textures[ 1 ] = loader.load('img/calculator.png');//JAIME: te puedes guiar con esto para llenar el array de URLs
  textures[ 2 ] = loader.load('img/cvs.png');
  textures[ 3 ] = loader.load('img/documents.png');
  textures[ 4 ] = loader.load('img/full_experience.png');
  textures[ 5 ] = loader.load('img/history_testimonials.png');
  textures[ 6 ] = loader.load('img/laboratory.png');
  textures[ 7 ] = loader.load('img/access.png');
  textures[ 8 ] = loader.load('img/nicarbazin.png');
  textures[ 9 ] = loader.load('img/roi.png');
  ...
  let urls = [ 'http://www.google.com', 'https://www.facebook.com', 'https://www.twitter.com', 'https://www.instagram.com', 'https://www.gmail.com', 'https://www.hbo.com', 'https://www.netflix.com', 'https://www.heroku.com', 'https://www.amazon.com', 'https://www.ebay.com' ]
  ...
  for( let i = 0; i < elementNumber; i++ ){
    let geometry = new THREE.PlaneGeometry(1, 1.2, 2, 2);
